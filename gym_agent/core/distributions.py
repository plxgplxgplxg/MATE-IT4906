...
class DiagGaussianDistribution(Distribution):
    ...
    def proba_distribution(
        self: 'DiagGaussianDistribution', mean_actions: th.Tensor, log_std: th.Tensor
...
class SquashedDiagGaussianDistribution(DiagGaussianDistribution):
    ...
    def proba_distribution(
        self: 'SquashedDiagGaussianDistribution', mean_actions: th.Tensor, log_std: th.Tensor
...
class CategoricalDistribution(Distribution):
    ...
    def proba_distribution(self: 'CategoricalDistribution', action_logits: th.Tensor) -> 'CategoricalDistribution':
...
class MultiCategoricalDistribution(Distribution):
    ...
    def proba_distribution(
        self: 'MultiCategoricalDistribution', action_logits: th.Tensor
...
class BernoulliDistribution(Distribution):
    ...
    def proba_distribution(self: 'BernoulliDistribution', action_logits: th.Tensor) -> 'BernoulliDistribution':
...
class StateDependentNoiseDistribution(Distribution):
    ...
    def proba_distribution(
        self: 'StateDependentNoiseDistribution', mean_actions: th.Tensor, log_std: th.Tensor, latent_sde: th.Tensor
...
def make_proba_distribution(
    ...
    use_sde = False # SDE not implemented yet

    if isinstance(action_space, spaces.Box):
        cls = StateDependentNoiseDistribution if use_sde else DiagGaussianDistribution
        return cls(np.prod(action_space.shape), **dist_kwargs)
